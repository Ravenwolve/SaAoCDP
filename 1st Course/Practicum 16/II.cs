    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            using (StreamReader FileIn = new StreamReader("C:/Users/Harvey/source/repos/P1-10/P1-10/input.txt", Encoding.GetEncoding(1251)))
            {
                ...
                {
                    Console.Write("Введите границу зарплаты для вывода информации сотрудников с зарплатой ниже на экран (с сортировкой по стажу): ");
                    uint Wage = uint.Parse(Console.ReadLine());
                    char[] Separators = { ' ', ',', '.', ';' };
                    string[] Data;
                    ...
                    var Result = Employees.Where(Emp => Emp.Wage < Wage).OrderByDescending(Emp => Emp.ExperienceYears);
